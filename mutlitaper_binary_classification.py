...
if __name__ == "__main__":
    ...
    model.fit(x_train, y_train, batch_size=4, epochs=10, verbose=1, validation_data=(x_test, y_test), callbacks=[ModelCheckpoint('model_multi_taper.h5',save_best_only=True)])
